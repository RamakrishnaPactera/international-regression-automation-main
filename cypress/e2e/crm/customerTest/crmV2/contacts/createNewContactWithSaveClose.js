...
let customerNameVal;
describe('Can I create Duplicate Contact(s) Detected, Associate Contact in the contacts Tab > Customer > CRMV2 > Contacts Tab > Duplicate Contacts [ME-122040]', () => {
  beforeEach(() => {
  ...
  it('ME-122040 Can I create Add new contact, Save and Close with an Associate Contact in the contacts Tab > CRMV2 > Contacts | Customer Regression | Sprint Regression', {
    tags: [
      '@customer',
      '@crm',
      '@customerContacts',
