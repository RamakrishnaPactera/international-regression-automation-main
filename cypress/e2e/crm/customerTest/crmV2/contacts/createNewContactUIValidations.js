...
let customerNameVal, contactDepName, addEntityEmail, randomContactName, contactFunctionName, addEntityPhNo, extPhn, contactPhLabel, contactEmailLabelName, randomPhNo, newContactTabEmailVal, newContactTabPhoneVal;
describe('Can I create Duplicate Contact(s) Detected, Associate Contact in the contacts Tab > Customer > CRMV2 > Contacts Tab > Duplicate Contacts [ME-122043, ME-130446]', () => {
  beforeEach(() => {
  ...
  it('ME-122043 Can I create Add new contact, Save and Continue with an Associate contact in the contacts Tab > CRMV2 > Contacts | Customer Regression | Sprint Regression', {
    tags: [
      '@customer',
      '@crm',
      '@customerContacts',
  ...
  () => {
    ...
    verifyAssCntWindowEmptyFields({ locator: txtEntityNameCustomer, randomName: randomContactName, entityName: customerNameVal.customerName });
  });
  it('ME-130446 Can I create Add new contact, Save and Continue with an Associate contact in the contacts Tab > CRMV2 > Contacts | Customer Regression | Sprint Regression', {
    tags: [
      '@customer',
      '@crm',
      '@customerContacts',
  ...
  () => {
    ...
    verifyAssCntWindowAllFields({ locator: txtEntityNameCustomer, entityName: customerNameVal.customerName, randomName: randomContactName, cntFunction: contactFunctionName, cntPhNo: addEntityPhNo, cntEmail: addEntityEmail });
    previousTab();
    waitSometime(longWait);
