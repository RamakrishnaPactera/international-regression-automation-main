...
let carrierNameVal;
describe('Can I create Duplicate Contact(s) Detected, Associate Contact in the contacts Tab > Customer > CRMV2 > Contacts Tab > Duplicate Contacts [ME-122048]', () => {
  beforeEach(() => {
  ...
  it('ME-122048 Can I create Add new contact, Save and Continue with an Associate contact in the contacts Tab > CRMV2 > Contacts | Carrier Regression | Sprint Regression', {
    tags: [
      '@carrier',
      '@crm',
      '@carrierContacts',
