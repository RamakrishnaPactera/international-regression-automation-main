...
Test cases Included           : ME-136705, ME-151329, ME-151330, ME-151332, ME-151337, ME-151339 Can user test Add new contact - Phone Field Validations & Data Sources in the contacts Tab > CRMV2 > Contacts
---------------------------------------------------------------------------------------------------------------*/
...
import { navigateToTheCrmV2Tab } from '../../../../../utilities/carrierUtils/carrierUtils';
...
const { tdmAddCarrierReq, tdmCarrierData, tdmCarrierNewScenario } = crmIndustryData.staticData;
const { userName: usernameText, password: passwordText } = Cypress.env('users')[Cypress.env('appLoginUser')];
let carrierNameVal, contactDepName, contactPhLabel, randomContactName;
...
describe('Can user test Add new contact - Phone Field Validations & Data Sources in the contacts Tab > CRMV2 > Contacts [ME-136705], [ME-151329], [ME-151330], [ME-151332], [ME-151337], [ME-151339]', () => {
  beforeEach(() => {
  ...
  it('ME-136705, ME-151329, ME-151330, ME-151332, ME-151337, ME-151339- Can user test Add new contact - Phone Field Validations & Data Sources in the contacts Tab > CRMV2 > Contacts | Carrier Regression | Regression',
    { tags: ['@carrier', '@crm', '@carrierContacts', '@p2'] },
    () => {
