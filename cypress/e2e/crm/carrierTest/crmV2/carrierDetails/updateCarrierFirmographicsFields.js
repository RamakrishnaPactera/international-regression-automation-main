...
import { searchCarrier, navigateToTheEditFirmographicsTab } from '../../../../../utilities/carrierUtils/carrierUtils';
import {
  clickAction,
  clickMenu,
...
let carrierNameVal;
describe('Can I Validate Create and Update Firmographics Fields Gross Profit, Assets, key Principle, Incorporated, Year Founded and Fiscal Year End Field > Carrier > CRM > Carrier details > Firmographics > Edit Field Validations [[ME-108480,ME-112027]', () => {
  before(() => {
  ...
  it('ME-108480 Can I Validate Create and Update Firmographics Fields Gross Profit, Assets, key Principle  > CRM > Carrier details | Carrier Regression | Sprint Regression',
    {
      tags: [
        '@carrier',
        '@crm',
  ...
  it('ME-112027 Can I Validate Create and Update Firmographics Fields Incorporated, Year Founded and Fiscal Year End Field  > CRM > Carrier details | Carrier Regression | Sprint Regression',
    {
      tags: [
        '@carrier',
        '@crm',
  ...
  it('ME-121688 Can I Validate Create and Update Firmographics Fields Stock Symbol Field > CRM > Carrier Details | Carrier Regression | Sprint Regression',
    {
      tags: [
        '@carrier',
        '@crm',
