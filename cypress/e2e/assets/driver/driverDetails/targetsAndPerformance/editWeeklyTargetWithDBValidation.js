/*---------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 Test case Included             : ME-137543,ME-137549 : To verify user is able to add weekly targets and the data is reflecting in DB and weekly Activity
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
...
describe('Driver edit weekly targets with DB validations - Regression Testcase [ME-137543,ME-137549]', () => {
  beforeEach(() => {
    cy.then(() => {
  ...
  it('ME-137543,ME-137549 : Weekly Target: user can see Edit New Weekly Target Popup Assets > Driver > Targets & Performance | Regression',
    {
      tags: [
        '@assets',
        '@resources',
