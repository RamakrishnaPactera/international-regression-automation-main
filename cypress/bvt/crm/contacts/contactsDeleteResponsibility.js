/*---------------------------------------------------------------------------------------------------------------
Verify Verify Delete Responsibility of contact object screen of contact table
Test Cases List
Authored By                   : Mamatha Polapalli
Date                          : 27-04-2023
Functions/Calling References  : contactPage,commonData,crmContactsData,utilities
Test cases Included           : [ME-146705] Verify Delete Responsibility of contact object screen of contact table> CRMV2 > Contacts > Customer | Carrier
---------------------------------------------------------------------------------------------------------------*/
...
describe('User Verifies Delete Responsibility in Contacts Object Screen from Customer & Carrier > CRMV2 > Contacts Tab [ME-146705]', () => {
  beforeEach(() => {
  ...
  it('[ME-146705] - Verify delete responsibility in contact object screen of Contacts Table from Customer && Carrier > CRMV2 > Contacts Tab | Customer Regression | Sprint Regression',
    {
      tags: [
        '@customer',
        '@carrier',
    ...
    () => {
      ...
      customerUtils.addResponsibility(divisionValue, businessUnitVal, modeValue, sizeValue, equipmentValue);
      customerUtils.deleteResponsibility();
