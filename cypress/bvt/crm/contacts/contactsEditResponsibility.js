/*---------------------------------------------------------------------------------------------------------------
Verify Verify Edit Responsibility of contact object screen of contact table
Test Cases List
Authored By                   : Mamatha Polapalli
Date                          : 27-04-2023
Functions/Calling References  : contactPage,commonData,crmContactsData,utilities
Test cases Included           : [ME-146704] Verify Edit Responsibility of contact object screen of contact table> CRMV2 > Contacts > Customer | Carrier
---------------------------------------------------------------------------------------------------------------*/
...
describe('User Verifies Edit Responsibility in Contacts Object Screen from Customer & Carrier > CRMV2 > Contacts Tab [ME-146704]', () => {
  beforeEach(() => {
  ...
  it('[ME-146704] - Verify Edit Responsibility in Contacts Object Screen of Contacts Table from Customer & Carrier > CRMV2 > Contacts Tab | Customer Regression | Sprint Regression',
    {
      tags: [
        '@customer',
        '@carrier',
    ...
    () => {
      ...
      customerUtils.addResponsibility(divisionValue, businessUnitVal, modeValue, sizeValue, equipmentValue);
      customerUtils.responsibilityKabobMenu();
      customerUtils.editResponsibility(divisionValue, businessUnitVal, modeValue, sizeValue, equipmentValue);
